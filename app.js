...
// const testArray = inventors.map((x) => {
//   veryOldInventors.push(x.first);
// });

// testArray

const filterYear = inventors.filter((x) => (x.year >= 1500) && (x.year <= 1599));

veryOldInventors = filterYear

// SIMON SIMON SIMON SIMON SIMON SIMON, what is the difference between Array.prototype.filter() and Array.filter()? What is this prototype?
